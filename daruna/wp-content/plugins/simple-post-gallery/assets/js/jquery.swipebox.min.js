...
if(title){$('#swipebox-top-bar').show();$('#swipebox-title').append(title);}else{$('#swipebox-top-bar').hide();}},isVideo:function(src){if(src){if(src.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/)||src.match(/vimeo\.com\/([0-9]*)/)||src.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/)||src.match(/dailymotion\.com\/([a-zA-Z0-9\-_]+)/)||src.match(/dai.ly\/([a-zA-Z0-9\-_]+)/)||src.match(/.mp4/)){return true;}
...
return $.map(qs,function(val,key){if(val&&val>''){return encodeURIComponent(key)+'='+encodeURIComponent(val);}}).join('&');},getVideo:function(url){var iframe='',youtubeUrl=url.match(/((?:www\.)?youtube\.com|(?:www\.)?youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/),youtubeShortUrl=url.match(/(?:www\.)?youtu\.be\/([a-zA-Z0-9\-_]+)/),vimeoUrl=url.match(/(?:www\.)?vimeo\.com\/([0-9]*)/),dailymotionUrl=url.match(/(?:www\.)?dailymotion\.com\/video\/([a-zA-Z0-9\-_]+)/),dailymotionShortUrl=url.match(/(?:www\.)?dai\.ly\/([a-zA-Z0-9\-_]+)/),mp4Url=url.match(/.mp4/),qs='';if(youtubeUrl||youtubeShortUrl){if(youtubeShortUrl){youtubeUrl=youtubeShortUrl;}
...
iframe='<iframe width="560" height="315" src="//www.dailymotion.com/embed/video/'+dailymotionUrl[1]+'"'+(plugin.settings.autoplayVideos?' allow="autoplay"':'')+' frameborder="0" allowfullscreen></iframe>';}else if(mp4Url){iframe='<video width="540" height="310" controls><source src="'+url+'"" type="video/mp4"></video>';}else{iframe='<iframe width="560" height="315" src="'+url+'" frameborder="0" allowfullscreen></iframe>';}
